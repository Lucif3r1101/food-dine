# Devil's Wings Restaurant - React restaurant website
Built using React, Redux integrated with Node.js and Express backend
...
## Testing
1. In project directory run in terminal: `npm test`"# food-dine" 
